...
const styles = StyleSheet.create({
  header: { paddingTop: 14, paddingHorizontal: 16, paddingBottom: 10, flexDirection: "row", alignItems: "center", backgroundColor: "#fff", borderBottomWidth: 1, borderColor: "#eee", gap: 8 },
  dot: { width: 10, height: 10, borderRadius: 5 },
  title: { fontSize: 18, fontWeight: "700", flex: 0 },
  typing: { marginLeft: 8, color: "#22c55e", fontStyle: "italic" },
  inputRow: { flexDirection: "row", padding: 10, backgroundColor: "#fff", borderTopWidth: 1, borderColor: "#eee", alignItems: "center" },
  input: { flex: 1, borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 999, paddingHorizontal: 14, paddingVertical: 10, backgroundColor: "#fafafa", marginRight: 8 },
  sendBtn: { backgroundColor: "#2563eb", borderRadius: 999, paddingVertical: 10, paddingHorizontal: 16 },
});
